...
const user = {
    ...
    localStorage.setItem('payur',`sheetid=${user.sheetid}&formid=${user.formid}&sa=${user.sa}&sd=${user.sd}&sr=${user.sr}&name=${encodeURIComponent(user.name)}&mail=${user.mail}&id=${user.id}`);
